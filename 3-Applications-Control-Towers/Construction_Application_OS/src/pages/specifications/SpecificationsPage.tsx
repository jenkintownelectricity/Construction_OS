/**
 * Construction OS — Specifications Vault Page
 * Wave C1 — Deterministic table from frozen mock data.
 */

import { tokens } from '../../ui/theme/tokens';
import { MOCK_SPECIFICATIONS } from '../../mock/primitives/mockSpecifications';
  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: t.font.sizeXl, fontWeight: Number(t.font.weightBold), margin: 0 }}>Specifications</h1>
        <p style={{ fontSize: t.font.sizeSm, color: t.color.fgSecondary, marginTop: '4px' }}>
          Specification primitives — ASTM, FM, UL standards enforcement
        </p>
      </div>
      <div
        style={{
