/**
 * Construction OS — Scope Vault Page
 * Wave C1 — Deterministic table from frozen mock data.
 */

import { tokens } from '../../ui/theme/tokens';
import { MOCK_SCOPE } from '../../mock/primitives/mockScope';
  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: t.font.sizeXl, fontWeight: Number(t.font.weightBold), margin: 0 }}>Scope</h1>
        <p style={{ fontSize: t.font.sizeSm, color: t.color.fgSecondary, marginTop: '4px' }}>
          Scope primitives — project scope definition and boundary governance
        </p>
      </div>
      <div
        style={{
