/**
 * Construction OS — Materials Vault Page
 * Wave C1 — Deterministic table from frozen mock data.
 */

import { tokens } from '../../ui/theme/tokens';
import { MOCK_MATERIALS } from '../../mock/primitives/mockMaterials';
  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: t.font.sizeXl, fontWeight: Number(t.font.weightBold), margin: 0 }}>Materials</h1>
        <p style={{ fontSize: t.font.sizeSm, color: t.color.fgSecondary, marginTop: '4px' }}>
          Material primitives — properties, chemistry, and compatibility tracking
        </p>
      </div>
      <div
        style={{
