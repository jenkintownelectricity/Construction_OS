/**
 * Construction OS — Chemistry Vault Page
 * Wave C1 — Deterministic table from frozen mock data.
 */

import { tokens } from '../../ui/theme/tokens';
import { MOCK_CHEMISTRY } from '../../mock/primitives/mockChemistry';
  ...
  return (
    <div>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: t.font.sizeXl, fontWeight: Number(t.font.weightBold), margin: 0 }}>Chemistry</h1>
        <p style={{ fontSize: t.font.sizeSm, color: t.color.fgSecondary, marginTop: '4px' }}>
          Chemistry primitives — composition, compatibility, and compound analysis
        </p>
      </div>
      <div
        style={{
